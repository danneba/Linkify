    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col justify-center gap-4 items-center">
        ...
        <div className="flex justify-between gap-x-44 mt-8">
          <a
            ...
            className="flex flex-col cursor-pointer relative shadow-sm hover:shadow-xl py-14 rounded-lg border px-6 items-center justify-center"
          >
            <img src={dan} className="rounded-full w-44  mb-6 bg-cover" />
            <p className="flex ml-6 mt-4 text-2xl font-semibold">
              Daniel Kassahun
            </p>
          ...
          <a
            ...
            className="flex flex-col cursor-pointer relative shadow-sm hover:shadow-xl py-14 rounded-lg border px-6 items-center justify-center"
          >
            <img src={eph} className="rounded-full w-44  mb-6" />
            <p className="flex ml-6 mt-4 text-2xl font-semibold">
              Ephrem Demlew
            </p>
            <p className="flex ml-10  text-pretify text-lg">Co-founder</p>
      ...
      <div className="flex flex-col w-full bg-about py-8 justify-center items-center mt-32">
        ...
        <p className="text-white text-5xl font-semibold ">
          Create your events in 2 minutes
        </p>
        <div className="flex mt-12  ">
          <Link
            to="/login"
            className="flex py-4 px-8 bg-mainRed text-white text-lg font-semibold justify-center items-center"
          >
            Create Event
          </Link>
        </div>
