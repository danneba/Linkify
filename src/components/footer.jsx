  ...
  return (
    <>
      <div className="h-96 w-full relative text-white mt-32 flex items-end">
        <img src={footerBG} className="h-full absolute w-full" alt="" />
        <div className="z-20 h-60 w-full flex flex-col">
          <div className="bg-red-10 h-full w-full flex justify-between items-center px-60">
            <div className="flex flex-col justify-center">
              <img src={whiteIcon} alt="" className=" h-20 w-min" />
              <p className="w-72 pt-2">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
            <div className="mr-32 flex justify-center gap-x-20">
              <div>Home</div>
              <div>Venues</div>
              <div>About us</div>
            </div>
