...
function App() {
  return (
    ...
    //   <div className="flex flex-col w-full bg-nature-light p-8  h-[650px] ">
    //     <div className="flex justify-between">
    //       <img src={icon} alt="link" className="w-56 h-16 px-6" />
    //       <div className="flex justify-between gap-12 mr-4  mt-2">
    //         <ul className="flex text-white gap-8 mt-2 pr-4 ">
    //           <li>Home</li>
    //           <li>Home</li>
    //           <li>Home</li>
    //         </ul>
    ...
    //       <input
    //         type="text"
    //         className="flex w-[610px] h-14 justify-center bg-search-pic bg-no-repeat  items-center rounded-l-3xl"
    //       />
    //       <div className="flex w-44 rounded-r-3xl h-14 items-center justify-center text-xl font-normal bg-[#001235] text-white">
    //         Search
    //       </div>
    //     </div>
    //     <div className="flex items-center mt-44 justify-center gap-8 ">
